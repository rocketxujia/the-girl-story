...
<head id="girlWithColorfulLife" data-template-set="girl-with-colorful-life" profile="http://gmpg.org/xfn/11">
    ...
    <script type="text/javascript" src="<?php bloginfo('template_directory'); ?>/lib/js/css_browser_selector.js"></script>
	<script type="text/javascript" src="<?php bloginfo('template_directory'); ?>/lib/js/modernizr-1.7.min.js"></script>
